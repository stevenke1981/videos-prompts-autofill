...
export const TAG_STYLES = {
  ...
  "seedance": "bg-violet-50 text-violet-600 border border-violet-200",
  "kling": "bg-blue-50 text-blue-600 border border-blue-200",
  "grok": "bg-slate-50 text-slate-600 border border-slate-200",
  "runway": "bg-emerald-50 text-emerald-600 border border-emerald-200",
  "sora": "bg-amber-50 text-amber-600 border border-amber-200",
  "cinematic": "bg-rose-50 text-rose-600 border border-rose-200",
  "product": "bg-orange-50 text-orange-600 border border-orange-200",
  "anime": "bg-pink-50 text-pink-600 border border-pink-200",
  "commercial": "bg-indigo-50 text-indigo-600 border border-indigo-200",
  "landscape": "bg-teal-50 text-teal-600 border border-teal-200",
  "i2v": "bg-lime-50 text-lime-600 border border-lime-200",
  "dialogue": "bg-sky-50 text-sky-600 border border-sky-200",
